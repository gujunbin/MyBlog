...
public class AESUtil {
    ...
    private static final String ENCODE_RULES = "Gjub";
    ...
    public static String aesDecode(String content) {
        try {
            ...
            throw new RuntimeException("配置文件中的密码需要使用AES加密，请使用com.gujunbin.common.util.AESUtil工具类修改密码！");
        } catch (BadPaddingException e) {
            e.printStackTrace();
        }
        return null;
